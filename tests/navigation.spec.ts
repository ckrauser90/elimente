...
test.describe('Navigation', () => {
  ...
  test('2.1 Desktop-Navigation zeigt alle Menüpunkte', async ({ page }) => {
    ...
    await page.waitForTimeout(300); // CSS-Breakpoints anwenden lassen
    // Tatsächliche Nav-Links: #ueber, #angebote, #kurse, #galerie, #shop, #verleih, #standort
  ...
  test('2.6 Logo ist sichtbar und zeigt den Website-Namen', async ({ page }) => {
    // Logo ist ein <div class="logo"> in der Nav (kein Link)
